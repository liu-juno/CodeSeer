...
**2. AI 自动开发工作流（MCP 协同）**
平台内置 **MCP Server**，外部 AI 编码工具（Claude Code、Cursor 等）
可直接拉取已分析的需求，自动同步任务拆解、TDD 周期、测试结果到平台。
强制流程节点、阶段状态、Red/Green/Refactor 三态记录，让 AI 的工作
像团队成员一样"打卡上班"。
...
- 🤖 **AI 协同开发**：MCP 协议接入 AI 编码工具，任务/阶段/测试自动同步
